...
public class MenuPage extends ProjectWrappers {
	
	public MenuPage(RemoteWebDriver driver, ExtentTest test) throws InterruptedException {
		this.driver = driver;
		this.test = test;
	...
	public StatusPage clickStatus()
			throws InterruptedException {
		click("xpath", prop.getProperty("FlightStatus"));
		return new StatusPage(driver, test);
	}
